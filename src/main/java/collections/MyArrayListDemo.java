...
public class MyArrayListDemo {
    public static void main(String[] args) {
        ...
        //([10])>null
        //add(20)
        //([20]) tworzy nowy element lancucha
        //([10]) >([20])>null odnajduje ostatni element i ustawia mu ten nowy jako jego nastepny
        //add(30)
        //([30]) tworzy nowy element lancucha
        //([10]) >([20]) > ([30])>null odnajduje ostatni element i ustawia mu ten nowy jako jego nastepny
        //add(35)
        //([35]) tworzy nowy element lancucha
        //([10]) >([20]) > ([30])>([35])>null
